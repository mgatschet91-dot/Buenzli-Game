...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  // Park Infrastructure (Sheet 12) - Entrances
  infra_main_entrance: { name: 'Main Entrance', cost: 5000, description: 'Grand park entrance gate', category: 'infrastructure', size: { width: 3, height: 1 } },
  infra_themed_entrance: { name: 'Themed Entrance', cost: 8000, description: 'Decorated themed entrance', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_vip_entrance: { name: 'VIP Entrance', cost: 10000, description: 'Exclusive VIP entry building', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_exit_gate: { name: 'Exit Gate', cost: 2000, description: 'Park exit with lockers', category: 'infrastructure', size: { width: 2, height: 1 } },
  infra_turnstile: { name: 'Turnstile', cost: 500, description: 'Entry turnstile station', category: 'infrastructure', size: { width: 1, height: 1 } },
  // Admin Buildings
  infra_office: { name: 'Admin Office', cost: 3000, description: 'Park administration office', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_maintenance: { name: 'Maintenance Depot', cost: 2000, description: 'Maintenance and repair facility', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_warehouse: { name: 'Warehouse', cost: 2500, description: 'Storage warehouse', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_security: { name: 'Security Post', cost: 1500, description: 'Security checkpoint booth', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_break_room: { name: 'Staff Break Room', cost: 1000, description: 'Employee rest area', category: 'infrastructure', size: { width: 1, height: 1 } },
  // Guest Services
  infra_guest_relations: { name: 'Guest Relations', cost: 2000, description: 'Guest services center', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_lost_found: { name: 'Lost & Found', cost: 500, description: 'Lost and found booth', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_package_pickup: { name: 'Package Pickup', cost: 500, description: 'Package storage and pickup', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_ticket_booth: { name: 'Ticket Booth', cost: 1500, description: 'Day ticket sales booth', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_season_pass: { name: 'Season Pass Center', cost: 2000, description: 'Season pass sales office', category: 'infrastructure', size: { width: 1, height: 1 } },
  // Transport
  infra_tram_stop: { name: 'Tram Stop', cost: 3000, description: 'Covered tram station stop', category: 'infrastructure', size: { width: 2, height: 1 } },
  infra_bus_stop: { name: 'Bus Stop', cost: 1500, description: 'Open bus stop shelter', category: 'infrastructure', size: { width: 2, height: 1 } },
  infra_shuttle: { name: 'Shuttle Bay', cost: 2000, description: 'Shuttle pickup area', category: 'infrastructure', size: { width: 2, height: 2 } },
  infra_golf_cart: { name: 'Golf Cart', cost: 1000, description: 'Park golf cart station', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_utility_vehicle: { name: 'Utility Vehicle', cost: 1500, description: 'Utility vehicle depot', category: 'infrastructure', size: { width: 2, height: 1 } },
  // Utilities
  infra_generator: { name: 'Generator', cost: 2000, description: 'Backup power generator', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_dumpster: { name: 'Dumpster Area', cost: 300, description: 'Waste collection area', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_loading_dock: { name: 'Loading Dock', cost: 1000, description: 'Delivery loading platform', category: 'infrastructure', size: { width: 2, height: 1 } },
  infra_container: { name: 'Storage Container', cost: 500, description: 'Metal storage container', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_utility_box: { name: 'Utility Box', cost: 200, description: 'Electrical utility box', category: 'infrastructure', size: { width: 1, height: 1 } },
  // Safety
  infra_first_aid_station: { name: 'First Aid Station', cost: 1500, description: 'Medical first aid post', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_defibrillator: { name: 'AED Station', cost: 300, description: 'Automated defibrillator', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_fire_extinguisher: { name: 'Fire Station', cost: 200, description: 'Fire extinguisher post', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_emergency_phone: { name: 'Emergency Phone', cost: 200, description: 'Emergency call station', category: 'infrastructure', size: { width: 1, height: 1 } },
  infra_evacuation: { name: 'Evacuation Point', cost: 300, description: 'Emergency evacuation sign', category: 'infrastructure', size: { width: 1, height: 1 } },
};

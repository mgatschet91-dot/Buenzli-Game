...
export function PollutionIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      {/* Factory chimney */}
      <path {...baseStroke} d="M8 20V14h4v6" />
      {/* Smoke clouds */}
      <circle {...baseStroke} cx="10" cy="8" r="2.5" />
      <circle {...baseStroke} cx="14" cy="6" r="2" />
      <circle {...baseStroke} cx="17" cy="8" r="1.5" />
      {/* Ground */}
...
export function HouseIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      {/* Roof */}
      <path {...baseStroke} d="M3 12l9-8 9 8" />
      {/* Walls */}
      <path {...baseStroke} d="M5 12v7h14v-7" />
      {/* Door */}
      <path {...baseStroke} d="M10 19v-4h4v4" />
      {/* Window */}
      <rect {...baseStroke} x="14" y="13" width="3" height="2.5" rx="0.5" />
    </svg>
  );
}

export function ParkIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      {/* Tree crown */}
      <circle {...baseStroke} cx="12" cy="8" r="5" />
      {/* Trunk */}
      <path {...baseStroke} d="M12 13v5" />
      {/* Bench */}
      <path {...baseStroke} d="M6 20h12M7 18h10M7 18v2M17 18v2" />
    </svg>
  );
}

...
const UI_LABELS = {
  ...
  funds: msg('Kasse'),
  tax: msg('Steuer'),
  taxRate: msg('Steuersatz'),
  emptyLot: msg('Leeres Grundstück'),
  jobsLower: msg('Stellen'),
  jobs: msg('Arbeitsplätze'),
  hasPower: msg('Hat Strom'),
  noPower: msg('Kein Strom'),
  hasWater: msg('Hat Wasser'),
  noWater: msg('Kein Wasser'),
  happiness: msg('Glück'),
  health: msg('Gesundheit'),
  education: msg('Bildung'),
  safety: msg('Sicherheit'),
  environment: msg('Umwelt'),
  population: msg('Bevölkerung'),
  monthlyIncome: msg('Monatliche Einnahmen'),
  monthlyExpenses: msg('Monatliche Ausgaben'),
  weeklyNet: msg('Wöchentlicher Netto'),
  exitToMainMenu: msg('Zum Hauptmenü'),
  exitDialogTitle: msg('Zum Hauptmenü'),
  exitDialogDescription: msg('Möchtest du deine Stadt vor dem Beenden speichern?'),
  exitWithoutSaving: msg('Ohne Speichern beenden'),
  saveAndExit: msg('Speichern & Beenden'),
  zone: msg('Zone'),
};

...
// Bus line system constants
export const BUS_MAX_LINES = 5;
export const BUS_MIN_STOPS_PER_LINE = 2;
export const BUS_MAX_STOPS_PER_LINE = 6;
export const BUS_PASSENGER_CAPACITY = 20;
export const BUS_BOARDING_TIME_PER_PERSON = 0.4;
export const BUS_WAIT_TIMEOUT = 60; // seconds before pedestrian gives up waiting
export const BUS_LINE_COLORS = ['#f59e0b', '#ef4444', '#3b82f6', '#10b981', '#9333ea', '#ec4899', '#06b6d4', '#f97316'];
...
export const NON_LIT_BUILDING_TYPES = new Set([
  ...
  // Spezifische Baum- und Vegetationstypen haben keine Beleuchtung
...
export const RESIDENTIAL_BUILDING_TYPES = new Set(['house_small', 'house_medium', 'mansion', 'apartment_low', 'apartment_high', 'cabin_house']);
...
export const CLOUD_TYPE_CONFIG: Record<string, {
  ...
  cumulonimbus: { opacityMin: 0.6, opacityMax: 0.85, layerRestriction: 0, speedMult: 0.5,  scaleMin: 2.2, scaleMax: 3.5, puffCountMin: 8, puffCountMax: 14, puffStretchX: [1, 1.3], puffStretchY: [1, 1.5] },  // Towering, massive, dark thunderclouds
